...
impl<'b> WallpaperHandler<'_>{
    ...
    pub fn new<'b>(wallpaper: &'b mut Wallpaper) -> Self{
        WallpaperHandler{
...
fn main(){
    ...
    let mut wallpaper_handler: WallpaperHandler = WallpaperHandler::new(_wallpaper);
    wallpaper_handler.run_current_wallpaper();
}